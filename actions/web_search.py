...
def _ddg_search(query: str, max_results: int = 6) -> list[dict]:
    from ddgs import DDGS   # duckduckgo_search was renamed to ddgs — the old
                             # package is unmaintained and hits DDG's rate
                             # limit (403) far more often than the renamed one.
